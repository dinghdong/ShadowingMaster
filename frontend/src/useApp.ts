...
export function useApp() {
  ...
  return {
    ...
    wordBook: wordBook.wordBook, selectedWord: wordBook.selectedWord, wordDetail: wordBook.wordDetail, wordPopupOrigin: wordBook.wordPopupOrigin, wordbookLoading: wordBook.loading,
    error: auth.error, submitting: auth.submitting,
    ...
    videoRef: player.videoRef, playEndRef: player.playEndRef, loopSingleRef: player.loopSingleRef, suppressLoopRef: player.suppressLoopRef, playerLoading: player.playerLoading,
